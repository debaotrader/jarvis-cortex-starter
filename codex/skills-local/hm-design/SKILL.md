---
name: hm-design
description: "/hm-design — Validação de Interface. Modo design para auditar interface contra o mais alto padrão (Apple/Airbnb/Linear). Use quando solicitado a validar UI, design review, ou /hm-design."
---
